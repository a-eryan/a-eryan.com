  ...
  return (
    ...
    <h2 className="text-xl ml-2.5 border-b border-[rgba(0,0,0,0.25)] font-bold"> Featured Projects </h2>
      <div className="m-2.5 flex items-stretch flex-wrap lg:flex-nowrap lg:flex-row gap-4 w-auto h-full max-w-2200 mt-4">
        <Link href="/projects/better-mystevens" className="shadow-win95-button p-4 flex items-stretch flex-col w-auto gap-2  hover:shadow-win95-button-hover active:shadow-win95-active">
          ...
          <h3 className="text-lg text-center underline font-bold hover:text-primary "> Better MyStevens</h3>
