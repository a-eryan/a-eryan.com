...
export default function Projects() {
		return (
				<div className="flex flex-col min-h-screen justify-between "> {/*stack children vertically and make sure the taskbar is always at the bottom*/}
						<div className="shadow-win95-program flex flex-col grow relative ">
							...
							<div className="flex flex-col sm:flex-row gap-2 items-center mx-2.5 border-b border-[rgba(0,0,0,0.25)] p-1">
								<h1 className="text-center p-1 font-bold">Duck Study Hub</h1>
								<a href = "https://www.figma.com/design/LBbsnbGLlVahpSZpglYhKc/Duck-StudyHub?node-id=0-1&t=1PmttuJqjYhQDRjA-1" target="_blank" className="inline-block underline underline-offset-2 hover:text-primary icon-link">
									<Image src = "/figma-logo.svg" width={20} height={30} alt="Figma Logo" className="inline-block w-4 h-auto"/>Figma Prototype
								</a>
								<a href = "https://github.com/a-eryan/cs-546-group-proj" target="_blank" className="inline-block underline underline-offset-2 hover:text-primary icon-link">
				...
				<SlideShow slidesSources={["/duck-study-hub-preview.png", "/duck-study-hub-2.png", "/duck-study-hub-3.png"]} className="xl:ml-2.5 xl:w-1/2 xl:max-w-none" />
