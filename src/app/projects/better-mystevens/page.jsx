...
export default function Projects() {
		return (
				<div className="flex flex-col min-h-screen justify-between "> {/*stack children vertically and make sure the taskbar is always at the bottom*/}
					<div className="shadow-win95-program flex flex-col grow relative ">
						...
						<TitleBar pageName="Projects" iconSource="/shell_window5-1.png" />
							<div className="flex flex-col sm:flex-row gap-2 items-center mx-2.5 border-b border-[rgba(0,0,0,0.25)] p-1">
								<h1 className="text-center p-1 font-bold">Better MyStevens</h1>
								<a href = "https://www.figma.com/design/R6eU7a5rBj1AIen1rv8yZU/CS-545-Better-MyStevens-Prototype?node-id=0-1&t=a8kJkwaxML5j24Cs-1" target="_blank" className="inline-block underline underline-offset-2 hover:text-primary icon-link">
									<Image src = "/figma-logo.svg" width={20} height={30} alt="Figma Logo" className="inline-block w-4 h-auto"/>Figma Prototype
								</a>
								<a href = "https://better-mystevens.vercel.app/" target="_blank" className="inline-block underline underline-offset-2 hover:text-primary icon-link">
								...
								<a href = "https://github.com/a-eryan/CS545_Project" target="_blank" className="inline-block underline underline-offset-2 hover:text-primary icon-link">
					...
					<video src="/BetterMyStevensBefore-After.mp4" width={3200} height={1800} controls autoPlay muted playsInline className="xl:ml-2.5 bg-background shadow-win95-button w-full max-w-7xl xl:w-1/2 xl:max-w-none aspect-video object-cover mt-2 m-auto p-2">
						Your browser does not support the video tag.
					</video>
						<div className="mb-4 mx-2.5 xl:w-1/2">
					...
					<div className="mb-4 ml-2.5 pb-16">
									<h2 className="mt-4 mb-2 font-bold">Design & Development Process</h2>
										...
										<h2 className="mt-4 mb-2 font-bold">Results & Learning</h2>
