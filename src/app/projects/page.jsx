      ...
      <div className="shadow-win95-program flex flex-col grow">
        ...
        */} 
        <div className="flex flex-wrap gap-4 m-2.5 pb-16 ">
          <Link href="/projects/lumen-labs" className="project-card">
            ...
            <h3 className="text-center underline hover:text-primary">Lumen Labs</h3>
          ...
          <Link href="/projects/fuelme" className="project-card">
            ...
            <h3 className="text-center underline hover:text-primary">FuelMe</h3>
            <div className="flex flex-row justify-center flex-wrap gap-1 items-center" aria-label="Technologies used">
              <Image src="/figma-logo.svg" width={20} height={30} alt="Figma Icon" className="inline-block w-4 h-auto"/>
              <p className="text-center">Figma</p>
              <Image src="/react-logo.svg" width={24} height={24} alt="React Icon" className="inline-block w-6 h-auto "/>
            ...
            <p className="leading-relaxed text-center">Nutrition tracking app for achieving fitness goals through personalized macro targets.</p>
          </Link>
          
          <Link href="/projects/sentiment-analysis.ai" className="project-card">
            <Image src="/sentiment-analysis.ai-1.png" width={3200} height={2100} alt="sentiment-analysis.ai project preview screenshot" className="w-full  border-4 border-primary object-cover"/>
            <h3 className="text-center underline hover:text-primary">sentiment-analysis.ai</h3>
            <div className="flex flex-row justify-center flex-wrap gap-1 items-center" aria-label="Technologies used">
              <Image src="/figma-logo.svg" width={20} height={30} alt="Figma Icon" className="inline-block w-4 h-auto"/>
              <p className="text-center">Figma</p>
              <Image src="/react-logo.svg" width={24} height={24} alt="React Icon" className="inline-block w-6 h-auto "/>
          ...
          <Link href="/projects/better-mystevens" className="project-card">
            ...
            <h3 className="text-center underline hover:text-primary">Better MyStevens</h3>
            <div className="flex flex-row justify-center flex-wrap gap-1 items-center" aria-label="Technologies used">
              <Image src="/figma-logo.svg" width={20} height={30} alt="Figma Icon" className="inline-block w-4 h-auto"/>
              <p className="text-center">Figma</p>
              <Image src="/react-logo.svg" width={24} height={24} alt="React Icon" className="inline-block w-6 h-auto "/>
          ...
          */}
          <Link href="/projects/duck-study-hub" className="project-card">
            ...
            <h3 className="text-center underline hover:text-primary">Duck Study Hub</h3>
            <div className="flex flex-row justify-center flex-wrap gap-1 items-center" aria-label="Technologies used">
              <Image src="/figma-logo.svg" width={20} height={30} alt="Figma Icon" className="inline-block  w-4 h-auto"/>
              <p className="text-center">Figma</p>
          ...
          <Link href="/projects/offbrandarm-cpu" className="project-card">
            ...
            <h3 className="text-center underline hover:text-primary">OffBrandARM CPU</h3>
            ...
            <p className="leading-relaxed text-center">Eight-bit CPU with 2² binary representation of 4 total instructions, such as memory-related operations based off the Arm® architecture.</p>
          </Link>         
          <Link href="/projects/gemini-sentiment-analysis-study" className="project-card">
            ...
            <h3 className="text-center underline hover:text-primary">Democratizing Text Analysis? A Critical Evaluation of Google's Gemini Pro for Sentiment Classification</h3>
            <div className="flex flex-row justify-center flex-wrap gap-1" aria-label="Technologies used">
            ...
            <p className="leading-relaxed text-center">Statistical analysis comparing the sentiment classification accuracy of Google Gemini Pro against crowdworkers with over 1000 tweets.</p>
          </Link>
        </div>
      </div>
