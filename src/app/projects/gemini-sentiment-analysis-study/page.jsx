    ...
    <div className="flex flex-col min-h-screen justify-between "> {/*stack children vertically and make sure the taskbar is always at the bottom*/}
      <div className="shadow-win95-program flex flex-col grow relative ">
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-center mx-2.5 border-b border-[rgba(0,0,0,0.25)] p-1">
          <h1 className="flex justify-between font-bold p-1">
Democratizing Text Analysis? A Critical Evaluation of Google's Gemini Pro for Sentiment Classification</h1>
          <a href = "https://github.com/wilkflow/qssProj" target="_blank" className="inline-block underline underline-offset-2 hover:text-primary icon-link">
        ...
        <Image src="/gemini-pro-sentiment-study.png" width={3220} height={953} alt="sentiment-analysis.ai project preview screenshot" className="w-full h-full xl:w-1/2 object-cover mx-auto p-2"/>
        ...
        <div className="mb-4 ml-2.5 pb-16">
          ...
          <p className="leading-relaxed"> 
            After reading Steve Rathje’s and colleagues' paper <a href="https://www.pnas.org/doi/10.1073/pnas.2308950121" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-primary">"GPT is an effective tool for multilingual psychological text analysis"</a>,   our group came together as a collective to pursue a similar project and contribute to further research on whether other LLMs outside of ChatGPT can meet the same performance when it came to sentiment analysis. I first began looking through publicly available datasets to benchmark the AI against human-labeled ground truth, and discovered the Appen dataset, in which crowdworkers classified tweets. Given that there were 13 sentiment categories, I began by identifying the research methodology:
          </p>
